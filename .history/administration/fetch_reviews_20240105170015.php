...
?>
<section class="commentaires_sec">
   <!-- Afficher tous les membres enregistrés  -->
   <div class="container_user">
     <h2 class="title_rev">liste des avis clients</h2>
    ...
    <?php
     ...
     while($user = $req->fetch()){
        ...
        <tr>
            ...
            <td>
            <a class="btn btn-primary mb-2 mt-2" href="delete_avis.php?review_id=<?=$user['id']?>"> <i class="fa-regular fa-trash-can"></i></a>
            </td>
        </tr>
        <?php 
     }
