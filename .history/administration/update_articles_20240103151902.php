...
<section>
  <div class="form-container">
    ...
    <div class="form-group">
        <input type="text" name="titre" value="<?php echo $row['titre']; ?>"  class="form-control"  placeholder="Titre de l" required><br>
    </div>
    <div class="form-group">
        <input type="text" name="prix" value="<?php echo $row['prix']; ?>"  class="form-control"  placeholder="Titre de service" required><br>
    </div>
    <div class="form-group">
