...
<?php
     ...
     while($user = $req->fetch()){
        ...
        <a class="btn btn-primary" href="supprimer_articles.php?id=<?=$user['id']?>data-bs-toggle="modal" data-bs-target="#AjouterArticles"><i class="fa-regular fa-trash-can"></i></a>
        </td>
        </tr>
