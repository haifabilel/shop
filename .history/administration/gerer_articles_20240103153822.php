...
<div class="container_card my-6">
  ...
  <button class="btn btn-primary ajouter_articles" data-bs-toggle="modal" data-bs-target="#Ajouter">Ajouter services <i class="fa-solid fa-circle-plus" style="color: #ffffff;"></i> </button>
