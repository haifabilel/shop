...
<header class="header">
    <div class="flex">
        ...
        <div class="icons">
            ...
            <a href="wishlist.php" class="cart-btn"><i class="bi bi-suit-heart-fill"></i><sup class="">0</sup></a>
            <a href="cart.php" class="cart-btn"><i class="bi bi-cart-fill"></i><sup class="">0</sup></a>
