...
<section class="checkout-form">
   ...
   <h4>Resumé panier</h4>
      ...
      <input type="submit" value="order now" name="order_btn" class="btn mt-2"  data-bs-toggle="modal" data-bs-target="#modalShop" id="btn_check">
   </form>
...
<div class="modal fade" id="modalShop" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title fs-5" id="exampleModalToggleLabel">thank you for shopping!</h3>
