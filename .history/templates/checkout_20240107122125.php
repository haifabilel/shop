...
if(isset($_POST['order_btn'])){
   ...
   $detail_query =$conn->query("INSERT INTO `orders`(name, number, email, method, street, country, total_products, total_price) 
   VALUES('$name','$number','$email','$method','$street','$country','$total_product','$price_total')");
   ...
   if($cart_query && $detail_query){
      ...
      <div class='message-container'>
         ...
         <div class='customer-details'>
            ...
            <p> your address : <span>".$flat.", ".$street.", ".$country." - ".$pin_code."</span> </p>
